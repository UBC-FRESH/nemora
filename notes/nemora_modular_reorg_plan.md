...
10. **Testing & CI strategy**
    ...
    - [ ] Nightly FAIB/FIA ingest integration workflow exercising live downloads with environment-gated pytest selection.
        ...
        - Monitoring policy: rely on GitHub email notifications generated by the auto-created failure issues (`nightly-ingest-failure` label); ensure maintainers watch the repo and enable workflow email alerts.
