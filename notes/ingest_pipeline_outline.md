...
3. **Output**
   ...
   - [x] Track Parquet manifest adoption across docs/examples and decide when to make the format the default artifact (decision landed; CLI/docs now default to CSV+Parquet with `--no-parquet` opt-out).
